...
import { loginUser, saveAuthSession } from "@/lib/authService";

const LOGIN_IMAGE = "/AuthPhoto/LoginImage.jpg";
                    ...
                    <section className="rounded-3xl bg-white/65 p-6 shadow-sm backdrop-blur md:p-10 lg:p-12">
                        ...
                        <form onSubmit={handleLogin} className="space-y-5">
                            ...
                            <div className="flex justify-end">
                                <button
                                    type="button"
                                    className="text-sm font-medium text-[#013B09] transition hover:text-[#F96302]"
                                >
                                    Lupa Kata Sandi?
                                </button>
                            </div>
